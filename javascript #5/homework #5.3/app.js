...
let numberofIngredients = Number.prompt("Enter how many ingredients do you need for the recipe:")

let namesOfIngredients = String.prompt("Enter the names of every ingredient:")
